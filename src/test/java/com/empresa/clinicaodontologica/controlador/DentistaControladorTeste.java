...
public class DentistaControladorTeste {
    @Autowired
    ...
    @Test
    public void testarBuscarDentistaPorId() throws Exception {
        ...
        DentistaEntidade p1 = new DentistaEntidade("Nome A", "Sobrenome A", LocalDate.parse("1995-02-08"), "12345678911", "CRM-SP123456", true, e1, u1);
        assertTrue(dentistaServico.salvar(p1).getIdDentista() != null);

        mockMvc.perform(MockMvcRequestBuilders.get("/dentista/buscar/{id}",1).accept(MediaType.APPLICATION_JSON))

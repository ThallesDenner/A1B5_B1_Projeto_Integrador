...
public class TesteLogin implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        UsuarioEntidade usuario1 = new UsuarioEntidade(1, "paciente@webmail.com", senha1, TipoUsuarioEntidade.ROLE_PACIENTE, LocalDateTime.now());
        UsuarioEntidade usuario2 = new UsuarioEntidade(2, "dentista@webmail.com", senha2, TipoUsuarioEntidade.ROLE_DENTISTA, LocalDateTime.now());
